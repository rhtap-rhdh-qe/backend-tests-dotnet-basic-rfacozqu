...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/backend-tests-dotnet-basic-rfacozqu:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/backend-tests-dotnet-basic-rfacozqu-gitops
